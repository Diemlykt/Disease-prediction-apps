...
## User Interface
The Streamlit frontend provides an intuitive interface for healthcare professionals to input clinical data or upload brain MRI scans. Prediction results are displayed instantly. The interface is designed for ease of use, ensuring seamless integration into clinical workflows.

Scan the QR code below to access the deployed Alzheimer’s Disease Prediction Application. Use files in example_file to test the app
